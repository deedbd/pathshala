...
describe('the owner console: one vendor, many client schools', () => {
  ...
  test('the vendor signs in at its own door, and nowhere else', async () => {
    ...
    // Until somebody comes through the vendor's door this installation belongs to nobody but the
    // school that installed it. A single-school customer's head teacher is a super admin of the
    // founder school, and making *that* the vendor would lock every customer out of their own console.
    ...
    // and this account is the vendor from now on, which is the one thing coming through the door did
