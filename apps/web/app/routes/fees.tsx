...
export default function Fees() {
  ...
  const [tab, setTab] = useState<'dues' | 'invoices' | 'payments' | 'cheques' | 'instalments' | 'structures' | 'discounts'>('dues');
  const [drawer, setDrawer] = useState<'collect' | 'structure' | 'plan' | null>(null);
